...
public class TvSeriesTest {
  ...
  private TvSeries InceptionM;
  private TvSeries sameRefMedia;
  private TvSeries sameStateMedia;
  private TvSeries yetAnotherMedia;
  private TvSeries diffMedia;
  private TvSeries nullMedia;
  ...
  public void setUp() throws Exception {
    ...
    this.sameStateMedia = new TvSeries();
    ...
    this.yetAnotherMedia = new TvSeries();
  ...
  public void toStringT() {
    ...
    Assert.assertEquals("TvSeries{}", this.InceptionM.toString());
